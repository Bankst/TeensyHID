...
namespace TeensyHID.Comm
{
    ...
    public class HIDMessage : Object
    {
        ...
        public const ushort HeaderByteCount = 2;
        ...
        public HIDMessage(HIDOpcode opcode, bool largeMessage = false)
        {
            ...
            Write((byte)0); // placeholder for Opcode byte
        ...
        public byte[] ToArray(HIDConnection connection = null)
        {
            ...
            Buffer.BlockCopy(dataBytes, 0, ret, HeaderByteCount, buffer.Length - HeaderByteCount);
        ...
        /// </summary>
        public override string ToString() => $"Command=0x{Opcode:X} ({Opcode}), Length={_stream.Length}";
